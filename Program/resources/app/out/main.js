...
module.exports = function (e) {
    ...
    "use strict";
    var i = t(24), r = t(67), o = Object.prototype.toString;
    ...
    Object.defineProperty(n, "__esModule", {value: !0}), n.default = function (e, n, t, i = 12) {
        ...
        t && (o = t.getNativeWindowHandle().readUIntLE(0, 4)), setTimeout(() => {
            n.attachShadowWindow(r, i, o)
        }, 50)
    }
}, function (e, n) {
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(12), o = t(2), s = t(4).promisify, a = t(1).default.getLogger("Thunder.base.fs-utilities");
    !function (e) {
        function n(e) {
        ...
        e.readFileAW = function (e) {
            ...
            return i(this, void 0, void 0, function* () {
                let e = !1;
                const n = s(r.mkdtemp), i = (yield Promise.resolve().then(() => t(8))).tmpdir();
                try {
                    e = yield n(`${i}${o.sep}`)
                } catch (e) {
                    a.warning(e)
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), function (e) {
        let n, t, i, r, o, s, a, l, d, c, u, f, h, p, m, g, w, v, C;
        !function (e) {
        ...
        }(w = e.KeyFilter || (e.KeyFilter = {})), function (e) {
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(4), o = t(10), s = t(11);
    !function (e) {
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(21), o = t(12), s = t(13), a = t(1).default.getLogger("Thunder.base.tools-utilities"), l = t(2),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(2), r = t(61), o = t(14), s = t(5).default(i.join(__rootDir, "../bin/ThunderHelper.node"));
    !function (e) {
        e.getDriveInfo = function (e) {
            ...
            let n = s.getTaskTypeFromUrl(e);
            if (n === o.DownloadKernel.TaskType.Unkown && function (e) {
                e = e.toLowerCase();
                let n = !1;
                do {
                ...
                let t = /:\/\/\[(.+?)\].*/.exec(e);
                t || (t = /^ftp:\/\/.*?\[(.+?)\].*/.exec(e)), t && t[1] && r.isIPv6(t[1]) && (n = o.DownloadKernel.TaskType.P2sp)
            }
            return n
        }, e.extractIcon = function (e, n) {
            return s.extractIcon(e, n)
        }, e.isWindow7 = function () {
            return 1 === s.isWin7()
        }, e.compareStr = function (e, n) {
            return s.compareStr(e, n)
    ...
    "use strict";
    var i = t(3), r = t(69), o = {"Content-Type": "application/x-www-form-urlencoded"};
    ...
    var a, l = {
        adapter: ("undefined" != typeof XMLHttpRequest ? a = t(70) : "undefined" != typeof process && (a = t(28)), a),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(4), r = t(10), o = t(11), s = t(15), a = t(58);
    !function (e) {
        let n;
        !function (e) {
    ...
    "use strict";
    var i = t(3), r = t(25), o = t(27), s = t(29), a = t(30), l = t(31).http, d = t(31).https, c = t(32), u = t(84),
        f = t(85), h = t(19), p = t(26);
    e.exports = function (e) {
        return new Promise(function (n, t) {
            ...
            var C = c.parse(e.url), b = C.protocol || "http:";
            if (!v && C.auth) {
                var y = C.auth.split(":");
                v = (y[0] || "") + ":" + (y[1] || "")
            }
            v && delete w.Authorization;
            var _ = "https:" === b, T = _ ? e.httpsAgent : e.httpAgent, S = {
            ...
            var k, R = e.proxy;
            if (!R && !1 !== R) {
                var M = b.slice(0, -1) + "_proxy", N = process.env[M] || process.env[M.toUpperCase()];
                if (N) {
                    var x = c.parse(N);
            ...
            if (R && (S.hostname = R.host, S.host = R.host, S.headers.host = C.hostname + (C.port ? ":" + C.port : ""), S.port = R.port, S.path = b + "//" + C.hostname + (C.port ? ":" + C.port : "") + S.path, R.auth)) {
                var W = new Buffer(R.auth.username + ":" + R.auth.password, "utf8").toString("base64");
                S.headers["Proxy-Authorization"] = "Basic " + W
            }
            e.transport ? k = e.transport : 0 === e.maxRedirects ? k = _ ? a : s : (e.maxRedirects && (S.maxRedirects = e.maxRedirects), k = _ ? d : l), e.maxContentLength && e.maxContentLength > -1 && (S.maxBodyLength = e.maxContentLength);
    ...
    var i = t(32), r = t(29), o = t(30), s = t(75), a = t(76).Writable, l = t(77)("follow-redirects"),
    ...
    (n = e.exports = i.debug = i.default = i).coerce = function (e) {
        ...
        return !1
    }, n.humanize = t(79), n.instances = [], n.names = [], n.skips = [], n.formatters = {}
}, function (e, n, t) {
    "use strict";
    e.exports = function (e) {
    ...
    const o = t(0), s = t(12), a = t(1), l = t(6), d = t(9), c = t(46), u = t(2), f = t(5), h = t(47), p = t(16),
        m = t(48), g = t(49), w = t(50), v = t(51), C = t(7), b = t(52), y = t(13), _ = t(54), T = t(59), S = t(93);
    o.app.disableHardwareAcceleration();
    let k = u.join(__rootDir, "..\\..\\Thunder.exe");
    o.app.setAppUserModelId(k);
    const R = f.default(u.join(__rootDir, "../bin/ThunderHelper.node")), M = a.default.getLogger("Thunder.Main");
    M.information("trackShow maininterfaceEffectivelyshow");
    let N = null, x = !0, E = null, W = null, D = R.getTickCount(), P = c.HistoryDataNS.getMainWndSizeHistoryData(),
        I = !1, O = !0, F = 1020, L = 1020, A = 650, U = global;

    function B() {
        if (null !== E) {
            let e = E.getBounds(), n = e.x + Math.round((e.width - L) / 2), t = e.y + Math.round((e.height - A) / 2);
            E.setBounds({x: n, y: t, width: L, height: A})
        }
    }

    function j() {
        if (null !== E) {
            let e = E.getNativeWindowHandle().readUIntLE(0, 4);
            R.showWindow(e, S.showCmd.SW_SHOWMAXIMIZED)
        }
    }

    U.mainRendererWindow = null, U.suspensionWindow = null, U.silentMainWnd = !1, U.silentSupsWnd = !1, function () {
        for (let e = 0; e < process.argv.length; e++) "--autotest:startup" === process.argv[e] ? I = !0 : "-StartType:Install" === process.argv[e] ? (P.exitState = "normal", P.width = F, P.height = 650) : "-silent" === process.argv[e] ? U.silentMainWnd = !0 : "-nofloatwnd" === process.argv[e] && (U.silentSupsWnd = !0)
    }(), o.ipcMain.on("closeMainWindow", (e, n) => i(this, void 0, void 0, function* () {
        null !== E && ("BossKey" === n ? E.isVisible() ? (K("BossKey", "BossKeyState", !0), U.suspensionWindow.hide(), E.minimize(), E.hide(), N.destroy()) : (K("BossKey", "BossKeyState", !1), E.isMinimized() && E.restore(), E.show(), X(), $("ConfigFloatPanel", "FloatPanelValue", "0").then(e => {
        }).catch()) : (E.minimize(), E.hide()))
    })), o.ipcMain.on("maximizeMainWindow", () => {
        j()
    }), o.ipcMain.on("restoreMainWindow", () => {
        null !== E && ("max" === P.exitState && !0 === O ? (O = !1, B()) : (O = !1, E.restore()))
    ...
    o.ipcMain.on(l.ThunderChannelList.channelRMProcessSend, (e, n) => {
        ...
        for (let e = z.length - 1; e >= 0; --e) try {
            process.kill(z[e], 0)
        } catch (e) {
            c.HistoryDataNS.setExitType("normal"), o.app.quit()
        }
    }, 1e3);
    const H = "development" === process.env.RUN_ENV ? "http://localhost:9080/main-renderer/" : `file:///${__dirname}/main-renderer/index.html`,
        G = `${__rootDir}/out/common-preload.js`;

    function V() {
        let e = P.width, n = P.height;
        (F = o.screen.getPrimaryDisplay().size.width) <= 1024 ? (F = 356, e = 356) : F = 356, E = new o.BrowserWindow({
            width: e,
            height: n,
            minWidth: F,
            minHeight: 316,
            ...
            show: !1,
            backgroundColor: "#FFF",
            webPreferences: {devTools: !0, preload: G, webSecurity: !1}
        }), b.loginUIObj.init(E, R), m.default(E, R), T.NewTaskDlgsManagerNS.init(E, R), g.default(E, R), w.default(), v.default(E, R), U.mainRendererWindow = E, E.loadURL(H), R.initGDIPlus(), E.on("ready-to-show", () => {
            T.NewTaskDlgsManagerNS.setReady(!0), r.PerformanceMonitorStatNS.trackColdStartUpEvent("ready_to_show_of_mainwindow_in_main").catch(), "max" === P.exitState && j();
            let e = o.nativeImage.createFromPath(`${__rootDir}/static/thunderx.ico`);
            E.setIcon(e), X(), M.information("endThunderStartProcess"), R.endThunderStartProcess(), c.HistoryDataNS.setExitType("");
            let n = "areo=0";
            R.isDwmCompositionEnabled() && (n = "areo=1"), R.isDropShadowEnabled() ? n += ",shadow=1" : n += ",shadow=0", d.XLStatNS.trackEvent("core_event", "system_setting", "", 0, 0, 0, 0, n), I && s.writeFile("autoteststartup.txt", new Date, e => {
                e && M.information(e)
            }), setTimeout(() => i(this, void 0, void 0, function* () {
                yield Y(), setInterval(() => i(this, void 0, void 0, function* () {
                    yield Y()
                }), 6e5)
            }), 5e3), U.silentMainWnd ? (E.minimize(), E.hide()) : (E.isMinimized() && E.restore(), E.show(), p.ToolsUtilitiesAWNS.setForegroundWindow(R, E)), setTimeout(() => {
                W = new o.BrowserWindow({
                    frame: !1,
                    height: 260,
                    width: 394,
                    skipTaskbar: !0,
                    ...
                    x: -999,
                    y: -999,
                    webPreferences: {preload: G}
                }), U.suspensionWindow = W, W.loadURL(q), W.on("ready-to-show", () => {
                    C.default(W, R)
                }), R.initLiveUD()
            }, 2e3)
        }), E.on("close", e => {
            let n = c.HistoryDataNS.getExitType();
            M.information("close:exitType = ", n), "normal" !== n && (null !== E && (E.minimize(), E.hide()), e.preventDefault())
        }), E.on("show", () => {
            U.silentMainWnd = !1, U.silentSupsWnd = !1
        }), E.on("unmaximize", () => {
            "max" === P.exitState && !0 === O && (O = !1, B())
        }), h.MainWindowCoreEventStatNS.watch(R, E)
    }

    const q = "development" === process.env.RUN_ENV ? "http://localhost:9080/suspension-renderer/" : `file:///${__dirname}/suspension-renderer/index.html`;
            ...
            return new Promise(i => {
                do {
                    ...
                    o.ipcMain.once(l.ThunderChannelList.channelRMGetConfigValueResolve, (e, n) => {
                        ...
                        i(t)
                    }), E.webContents.send(l.ThunderChannelList.channelMRGetConfigValue, e, n, t)
                } while (0)
            })
        })
    }
    ...
    function K(e, n, t) {
        do {
            if (null === E) break;
            E.webContents.send(l.ThunderChannelList.channelMRSetConfigValue, e, n, t)
        } while (0)
    }

    function X() {
        M.information(`${__rootDir}/static/thunderx.ico`), null !== (N = new o.Tray(`${__rootDir}/static/thunderx.ico`)) && (M.information("settooltip"), N.setToolTip("迅雷"), N.on("click", () => {
            if (null !== E) {
                let e = E.isMinimized();
                if (!e && E.isVisible()) {
                    let e = "status=hidemain";
                    d.XLStatNS.trackEvent("client_quick", "tuopan_click_main_status_get", "", 0, 0, 0, 0, e), E.minimize(), E.hide()
                } else {
                    let n = "status=showmain";
                    d.XLStatNS.trackEvent("client_quick", "tuopan_click_main_status_get", "", 0, 0, 0, 0, n), e ? (E.restore(), E.show()) : E.show()
                }
            }
        }), N.on("right-click", () => i(this, void 0, void 0, function* () {
            let e = yield $("ConfigFloatPanel", "FloatPanelValue", "0"), n = !0;
            ...
            let r = [{
                type: "normal", label: "新建任务", icon: `${__rootDir}/static/icon/newtask.png`, click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=create"), E.webContents.send(l.ThunderChannelList.channelMRTrayMenuClick, "-task:newtask", "tray_menu")
                }
            }, {
                type: "normal",
                label: "开始全部任务",
                ...
                enabled: x,
                click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=start"), E.webContents.send(l.ThunderChannelList.channelMRTrayMenuClick, "-task:startall")
                }
            }, {
                type: "normal", label: "暂停全部任务", icon: `${__rootDir}/static/icon/stoptask.png`, click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=pause"), E.webContents.send(l.ThunderChannelList.channelMRTrayMenuClick, "-task:pauseall")
                }
            }, {
                type: "normal", label: "退出", icon: `${__rootDir}/static/icon/exit.png`, click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=exit"), E.webContents.send(l.ThunderChannelList.channelMRTrayMenuClick, "-task:quitprocess")
                }
            }];
            null !== W && r.splice(3, 0, {
                type: "submenu",
                ...
                submenu: [{
                    type: "checkbox", label: "显示悬浮窗", checked: n, click() {
                        do {
                            if (n) break;
                            let e = "result=show";
                            d.XLStatNS.trackEvent("client_quick", "tuopan_rk_float_monitor_setting", "", 0, 0, 0, 0, e), K("ConfigFloatPanel", "FloatPanelValue", "0")
                        } while (0)
                    }
                }, {
                    type: "checkbox", label: "下载时显示悬浮窗", checked: t, click() {
                        do {
                            ...
                            d.XLStatNS.trackEvent("client_quick", "tuopan_rk_float_monitor_setting", "", 0, 0, 0, 0, e), K("ConfigFloatPanel", "FloatPanelValue", "1")
                        } while (0)
                    }
                }, {
                    type: "checkbox", label: "隐藏悬浮窗", checked: i, click() {
                        d.XLStatNS.trackEvent("client_quick", "tuopan_rk_float_monitor_setting", "", 0, 0, 0, 0, "result=hide"), K("ConfigFloatPanel", "FloatPanelValue", "2")
                    }
                }]
            }), E.isVisible() && !E.isMinimized() ? r.splice(0, 0, {
                label: "隐藏主界面", type: "normal", click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=hidemain"), E.minimize(), E.hide()
                }
            }) : r.splice(0, 0, {
                label: "显示主界面", type: "normal", click() {
                    d.XLStatNS.trackEvent("client_quick", "tuopan_rk_click", "", 0, 0, 0, 0, "button=showmain"), E.isMinimized() && E.restore(), E.show()
                }
            });
            let s = o.Menu.buildFromTemplate(r);
            N.popUpContextMenu(s, _.WindowPreferenceNS.getWindowPreference(!0))
        })))
    }
            ...
            if (yield function e(n, t) {
                return i(this, void 0, void 0, function* () {
                    do {
                        ...
                        if (!(yield y.FileSystemAWNS.existsAW(n))) break;
                        let i = yield y.FileSystemAWNS.lstatAW(n);
                        if (i && i.isDirectory()) {
                            let i = yield y.FileSystemAWNS.readdirAW(n);
                            for (let r = 0; r < i.length; r++) yield e(u.join(n, i[r]), t)
                        } else i.size < 5242880 && t.push(n)
                    } while (0)
                })
            }(e, n), n.length > 0) for (let e = 0; e < n.length; ++e) R.asynPreLoadFile(n[e])
        })
    }
    ...
    function Y() {
        return i(this, void 0, void 0, function* () {
            ...
            for (let n = 0; n < e.length; ++n) yield J(u.join(__dirname, e[n]))
        })
    }

    o.app.on("ready", () => {
        r.PerformanceMonitorStatNS.trackColdStartUpEvent("ready_of_app_in_main").catch(), V()
    }), o.app.on("will-quit", () => {
        !function (e) {
            do {
                if (D <= 0) break;
                let n = (R.getTickCount() - D) / 1e3;
                if (n < 0) break;
                void 0 === e && (e = "manual"), h.MainWindowCoreEventStatNS.onExit();
                let t = "exitType=" + e + ",online_time=" + n;
                M.information("client_all_online_time", t), d.XLStatNS.trackEvent("core_event", "client_all_online_time", "", 0, 0, 0, 0, t)
            } while (0)
        }(), global.xlDesktopApplicationSolution.GetPerformanceMonitorReport().uninitPerformanceMonitor(), o.globalShortcut.unregister("ctrl+f12"), o.globalShortcut.unregister("Alt+D"), o.globalShortcut.unregisterAll(), M.information("main will quit"), R.uninitGDIPlus(), N.destroy()
    }), o.app.on("window-all-closed", () => {
        "darwin" !== process.platform && o.app.quit()
    }), o.app.on("browser-window-created", (e, n) => {
        n.once("close", () => {
            let e = n.webContents.getOSProcessId();
            R.removeProcessEnvironmentVariable(e.toString())
        }), n.webContents.on("dom-ready", () => {
            let e = n.webContents.getURL(), t = n.webContents.getOSProcessId();
            R.setProcessEnvironmentVariable(t.toString(), e)
        })
    }), process.on("SIGINT", () => {
        c.HistoryDataNS.setExitType("normal"), o.app.quit()
    }), o.ipcMain.on(l.ThunderChannelList.channelRMFileCopy, (e, n, t) => {
        M.information("asynCopyFile", n, t), R.asynCopyFile(n, t, (n, t) => {
        ...
        M.information("asynMoveFile", n, t), R.asynMoveFile(n, t, (n, t) => {
        ...
        M.information("bringWindowToTop", n), R.bringWindowToTop(n)
    }), o.ipcMain.on(l.ThunderChannelList.channelRMSetProgressBar, (e, n) => {
        E.setProgressBar(n)
    }), o.ipcMain.on(l.ThunderChannelList.channelRMSetFoucs, () => {
        M.information("setMainWindowFocus"), E.focus()
    }), o.ipcMain.on("can-start-all-task", (e, n) => {
        x = n, W && W.webContents.send("can-start-all-task", n)
    }), o.ipcMain.on("onOpenExecute", (e, n, t, i) => {
        if (null !== n && void 0 !== n && "" !== n) {
            null !== E && (E.isMinimized() && E.restore(), p.ToolsUtilitiesAWNS.setForegroundWindow(R, E), E.show());
            let e = u.dirname(n);
            null !== i && void 0 !== i && "" !== i && (e = i), R.asyncShellExecuteAndWait(n, e, t, (i, r) => {
                M.information("shellExecute:result = ", i, ";code = ", r, ";filePath = ", n, ";directory = ", e, ";params = ", t)
            })
        }
    }), o.ipcMain.on(l.ThunderChannelList.channelRMExecute, (e, n, t, i, r, o, s) => {
        let a = E.getNativeWindowHandle().readUIntLE(0, 4), d = R.shellExecute(a, t, i, r, o, s);
        ...
        do {
            ...
            v < 0 ? v = 0 : v > p - c[0] && (v = p - c[0]), C < 0 ? C = 0 : C > m - c[1] && (C = m - c[1]), R.setWindowPos(e, 0, v * h, C * h, 0, 0, 5)
        } while (0);
        e.returnValue = !0
    })
}, function (e, n, t) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(4), o = t(10), s = t(11), a = t(15);
    !function (e) {
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(8), o = (t(12), t(2)), s = t(4);
    let a = null;
    const l = t(9), d = t(0), c = t(1), u = t(5), f = t(6), h = "xdas_profile_stat";
    let p = "", m = void 0, g = null, w = void 0, v = null,
        C = u.default(o.join(__rootDir, "../bin/ThunderHelper.node")), b = new Set;
    ...
    function R(e, n, t, r) {
        return i(this, void 0, void 0, function* () {
            let o = _(n), s = _(t), a = yield S(s), d = function (e) {
            ...
            }(_(r)), c = yield S(d), u = `${e}:${a}:${c}`;
            b.has(u) || (b.add(u), l.XLStatNS.trackEvent(h, "uncaught_exception", "", 0, 0, 0, 0, `type=${e},business_name=${yield y()},code=${o},message_hash=${a},message=${encodeURI(s)},stack_hash=${c},stack=${encodeURI(d)}`)), function (e, n, t, r) {
                return i(this, void 0, void 0, function* () {
                })
            }().catch()
        })
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(1), r = t(9), o = t(6), s = i.default.getLogger("Thunder.Main");
    let a = null, l = 0, d = void 0;

    function c(e, n) {
        let t = "status=smallwindow";
        e && (t = "status=bigwindow"), r.XLStatNS.trackEvent("core_event", "main_effective_show", "", 0, 0, 0, 0, t), l = a.getTickCount(), n && n.webContents.send("main-window-state-active-show")
    }
    ...
    function u() {
        do {
            ...
            l = 0, s.information("window online stat ", n), r.XLStatNS.trackEvent("core_event", "main_effective_online_time", "", 0, 0, 0, 0, t)
        } while (0)
    }

    function f(e) {
        let n = new Date;
        e.webContents.send(o.ThunderChannelList.channelMRShowOrHideWindow, "show", n.getTime())
    }

    function h(e) {
        let n = new Date;
        e.webContents.send(o.ThunderChannelList.channelMRShowOrHideWindow, "hide", n.getTime())
    }

    !function (e) {
        e.watch = function (e, n) {
            a = e, n.on("show", () => {
                n.webContents.send(o.ThunderChannelList.channelMRMainWndRestore), "" !== d && (c(n.isMaximized(), n), f(n)), d = ""
            }), n.on("restore", () => {
                n.webContents.send(o.ThunderChannelList.channelMRMainWndRestore), "minimize" !== d && "hide" !== d || (s.information("窗口展示上报resotre window show stat"), c(n.isMaximized(), n), f(n)), d = ""
            }), n.on("maximize", () => {
                n.webContents.send(o.ThunderChannelList.channelMRMainWndMax), "minimize" !== d && "hide" !== d || (s.information("窗口展示上报maximize window show stat"), c(n.isMaximized(), n), f(n)), d = ""
            }), n.on("hide", () => {
                n.webContents.send(o.ThunderChannelList.channelMRMainWndMin), d = "hide", u(), h(n)
            }), n.on("minimize", () => {
                n.webContents.send(o.ThunderChannelList.channelMRMainWndMin), d = "minimize", u(), h(n)
            })
        }, e.onExit = function () {
            u()
        }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(1), o = t(6), s = t(7), a = r.default.getLogger("SearchWindows");
    let l = null, d = null;
    n.default = function (e, n) {
        i.ipcMain.on(o.ThunderChannelList.channelRMCreateSearchWindow, (t, r, c, u) => {
            do {
                if (null !== l) break;
                const t = "development" === process.env.RUN_ENV ? "http://localhost:9080/search-renderer/" : `file:///${__dirname}/search-renderer/index.html`;
                d = e, (l = new i.BrowserWindow({
                    x: r,
                    y: c,
                    width: u,
                    height: 246,
                    ...
                    show: !1,
                    backgroundColor: "#FFF"
                })).loadURL(t), l.on("ready-to-show", () => {
                    a.information("search ready......")
                }), l.once("show", () => {
                    a.information("search show......"), s.default(l, n, e)
                }), l.on("blur", () => {
                    l.hide(), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !1)
                }), d.on("hide", () => {
                    l.hide(), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !1)
                }), d.on("resize", () => {
                    l.hide(), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !1)
            ...
            if (null !== l) {
                a.information("show-search-window", n, t, i, r);
                let e = d.getBounds();
                d.isMaximized() && (e.x = e.x + 4, e.y = e.y + 4), l.setBounds({
                    x: e.x + n,
                    y: e.y + t,
                    width: i,
                    height: r
                }), l.showInactive(), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !0)
            }
        }), i.ipcMain.on(o.ThunderChannelList.channelRMHideSearchWindow, (n, t) => {
            null !== l && (l.hide(), a.information("channelRMHideSearchWindow forceClose", t), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !1, t), t && e.webContents.send(o.ThunderChannelList.channelMRSearchBarFocusChange, !1))
        }), i.ipcMain.on(o.ThunderChannelList.channelRMClickMouse, (n, t, r, s, a, c, u) => {
            if (null !== l) {
                let n = i.screen.getCursorScreenPoint(), f = i.screen.getDisplayNearestPoint(n).scaleFactor;
                t = Math.round(t / f), r = Math.round(r / f);
                let h = d.getBounds();
                (t < h.x + s || t > h.x + c || r < h.y + a || r > h.y + u) && (l.hide(), l.webContents.send(o.ThunderChannelList.channelMRSearchWindowVisibleChange, !1), e.webContents.send(o.ThunderChannelList.channelMRSearchBarFocusChange, !1))
            }
            ...
            l && l.isVisible() && l.webContents.send(o.ThunderChannelList.channelMRFWAddressKeyDown, n)
        })
    }
}, function (e, n, t) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(1).default.getLogger("path-selector");
    let o = {};
    n.default = function () {
        i.ipcMain.on("dropdown-file-window-create", (e, n, t) => {
            do {
                let e = i.BrowserWindow.fromId(n);
                if (!e) break;
                if (o.hasOwnProperty(String(n))) {
                    r.information("create window but exist");
                    break
                }
                let s = new i.BrowserWindow({frame: !1, resizable: !1, parent: e, show: !1, width: 400, height: 229});
                o[n] = s, s.on("ready-to-show", () => {
                    s.webContents.send("dropdown-file-window-created", t)
                }), e.on("close", () => {
                    r.information("parent close"), s.close()
                }), s.on("close", () => {
                }), s.on("closed", () => {
                    delete o[n]
                }), s.on("blur", () => {
                ...
                const a = "development" === process.env.RUN_ENV ? "http://localhost:9080/dropdown-file-renderer/" : `file:///${__dirname}/dropdown-file-renderer/index.html`;
                s.loadURL(a)
            } while (0)
        }), i.ipcMain.on("dropdown-file-window-show", (e, n, t, s) => {
            do {
                let e = i.BrowserWindow.fromId(n);
                if (o.hasOwnProperty(String(n))) {
                    let a = o[n];
                    ...
                    if (!l) break;
                    let d = i.screen.getCursorScreenPoint(), c = i.screen.getDisplayNearestPoint(d).workAreaSize.height,
                        u = e.getBounds(), f = a.getSize(), h = u.y + l.bottom;
                    r.information("show dropdown", h, c), h + f[1] > c && (h = u.y + l.top - f[1]), a.setBounds({
                        x: Math.floor(u.x + l.left),
                        y: Math.floor(h),
                        width: Math.floor(l.width),
                        height: Math.floor(f[1])
                    }), a.show(), a.focus()
                } else r.error("show dropdown window but doesnot created")
            } while (0)
        }), i.ipcMain.on("dropdown-file-window-select", (e, n, t, r) => {
            let s = i.BrowserWindow.fromId(n);
            for (let e in o) if (o[e] === s) {
                let n = i.BrowserWindow.fromId(Number(e));
                n.webContents.send("dropdown-file-window-select", t, r), n.focus();
                break
            }
        }), i.ipcMain.on("dropdown-file-window-click-hide", (e, n) => {
            let t = i.BrowserWindow.fromId(n);
            t.hide();
            for (let e in o) if (o[e] === t) {
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(4), o = t(1), s = t(16), a = t(22), l = t(53), d = t(7), c = t(9),
        u = o.default.getLogger("LoginUI");
    n.loginUIObj = new class {
        ...
        init(e, n) {
            ...
            }), i.ipcMain.on("create-personal-info-window", (e, n, t) => {
                let i = this.createPersonalInfoWnd(n, t);
                e.sender.isDestroyed() || e.sender.send("personal-info-window-created", i.id)
            })
        }

        createLoginWnd(e, n, t, o, l) {
            if (u.information("create loginwnd:", e, n, t, o, l, this.loginWnd), null !== this.loginWnd && void 0 !== this.loginWnd && !this.loginWnd.isDestroyed()) return u.information("createLoginWnd: 登陆框已经存在"), void(!0 === this.isShowLoginWnd && (this.loginWnd.show(), s.ToolsUtilitiesAWNS.setForegroundWindow(this.thunderHelperObj, this.loginWnd)));
            if (r.isNullOrUndefined(e) || r.isNullOrUndefined(n)) u.information("createLoginWnd: 参数有问题"); else if (n = "file:///" + n, r.isNullOrUndefined(o) && (o = 300), r.isNullOrUndefined(l) && (l = 440), this.loginWndDefaultWidth = o, this.loginWndDefaultHeight = l, this.loginWnd = new i.BrowserWindow({
                ...
                if (this.isShowLoginWnd = !1, this.loginWnd.loadURL(n), a.ThunderWindowNS.centerWnd(this.loginWnd, this.parentWnd, this.thunderHelperObj), null !== t && void 0 !== t && "" !== t) {
                    let e = `logfrom=${t}`;
                    c.XLStatNS.trackEvent("user_info", "loginpanel_show", "", 0, 0, 0, 0, e)
                }
                this.loginWnd.on("close", () => {
                }), this.loginWnd.once("show", () => {
                    d.default(this.loginWnd, this.thunderHelperObj, this.parentWnd)
                }), this.loginWnd.once("closed", () => {
                    u.information("loginWnd closed");
                    do {
        ...
        closeLoginWnd(e) {
            u.information("closeLoginWnd:", e), null === this.loginWnd || void 0 === this.loginWnd || this.loginWnd.isDestroyed() || this.loginWnd.close()
        }

        updateLoginWnd(e, n, t, i, r) {
            let o = !1;
            do {
                if (u.information("updateLoginWnd:", e, n, t, i, this.loginWnd), null === this.loginWnd || void 0 === this.loginWnd || this.loginWnd.isDestroyed()) {
                    u.information("updateLoginWnd:不显示登陆框 this.loginWnd 存在问题");
                    break
                }
                if (!0 === this.isShowLoginWnd) {
                    u.information("updateLoginWnd:登陆框已经处于显示状态");
                    break
                }
                e ? (u.information("updateLoginWnd:显示登陆框"), this.isShowLoginWnd = !0, (this.parentWnd.isMinimized() || !1 === this.parentWnd.isVisible()) && (this.parentWnd.isMinimized() && this.parentWnd.restore(), this.parentWnd.show()), this.loginWnd.show(), o = !0, s.ToolsUtilitiesAWNS.setForegroundWindow(this.thunderHelperObj, this.loginWnd)) : this.loginWnd.hide()
            } while (0);
            return o
        }
        ...
        createRetryLoginWnd(e, n) {
            ...
            if ("userAvatar" === e) {
                ...
                e.x < 0 || e.y < 0 ? e.width > n[0] && e.height > n[1] ? (t = e.x + Math.round((e.width - n[0]) / 2), r = e.y + Math.round((e.height - n[1]) / 2) - 1) : (t = -1, r = -1) : (t = e.x, r = e.y), u.information("createRetryLoginWnd:", e, n)
            }
        ...
        createPersonalInfoWnd(e, n) {
            const t = "development" === process.env.RUN_ENV ? "http://localhost:9080/personal-info-renderer/" : `file:///${__dirname}/personal-info-renderer/index.html`;
            let r = this.parentWnd, o = r.getBounds(), s = r.getContentSize();
            (o.x < 0 || o.y < 0) && (o.width >= s[0] && o.height >= s[1] ? (o.x = o.x + Math.round((o.width - s[0]) / 2), o.y = o.y + Math.round((o.height - s[1]) / 2) - 1) : (o.x = -1, o.y = -1)), u.information("updatePersonalInfoWnd:", o, s, e);
            ...
            return i.ipcMain.once("personal-info-init", t => {
                u.information("personal-info-init");
                try {
                    t.sender.send("personal-info-init-reply", e, n)
                } catch (e) {
                    u.warning("err", e)
                }
            }), a.on("ready-to-show", () => {
                d.default(a, this.thunderHelperObj, this.parentWnd)
            }), a.on("closed", () => {
    ...
    (function () {
        return i(this, void 0, void 0, function* () {
            if ("renderer" === process.type) {
                ...
                const e = yield Promise.resolve().then(() => t(57)), n = yield Promise.resolve().then(() => t(23));
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(0), o = t(9), s = t(1), a = t(22), l = t(6), d = t(7), c = t(60), u = t(16), f = t(62),
        ...
        bringMainWindowToTop(e) {
            return i(this, void 0, void 0, function* () {
                ...
                do {
                    ...
                    this.isReady && null !== this.parent && (this.parent.isMinimized() && this.parent.restore(), this.parent.isVisible() ? this.parent.focus() : this.parent.show(), u.ToolsUtilitiesAWNS.setForegroundWindow(this.helperObj, this.parent))
                } while (0)
            })
        }
            ...
            return i(this, void 0, void 0, function* () {
                if (null === this.preNewTaskWindow) {
                    ...
                    this.preNewTaskWindow.loadURL(v), this.preNewTaskWindow.once("show", () => {
                        d.default(this.preNewTaskWindow, this.helperObj, w), g && this.bringMainWindowToTop(!1).catch()
                    }), this.preNewTaskWindow.on("ready-to-show", () => i(this, void 0, void 0, function* () {
                        if (e) if (e = yield this.changeUrllistToNewTaskData(e, n)) if (e.length <= 5) this.sendTaskDataToPreNewTaskRenderer(JSON.stringify(e), t, s, l); else {
                        ...
                        do {
                            if (null === this.parent || this.parent.isDestroyed()) break;
                            this.preNewTaskWindow = null, (yield this.ipcMainGetConfigValueAW("TaskDefaultSettings", "NewTaskDlgWithoutMainWnd", !0)) && this.bringMainWindowToTop(!1).catch()
                        } while (0)
                    }))
            ...
            return i(this, void 0, void 0, function* () {
                do {
                    ...
                    r.ipcMain.once(l.ThunderChannelList.channelRMNewTaskReadyForSetTaskData, n => {
                        ...
                        d.default(this.newTaskWindow, this.helperObj, f), this.bringMainWindowToTop().catch(), o.XLStatNS.trackEvent("core_event", "create_task_panel_show", "", 0, 0, 0, 0, "source=Thunder,panel=NewTaskDlg"), h.information("trackEvent", "core_event", "create_task_panel_show", "source=Thunder,panel=NewTaskDlg"), h.information("create new task browser window ready to show")
                        ...
                        do {
                            if (null === this.parent || this.parent.isDestroyed()) break;
                            (yield this.ipcMainGetConfigValueAW("TaskDefaultSettings", "NewTaskDlgWithoutMainWnd", !0)) && this.bringMainWindowToTop(!1).catch()
                        } while (0)
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(0), o = t(2), s = t(1), a = t(13), l = t(17), d = s.default.getLogger("Thunder.Util"),
    ...
    !function (e) {
        ...
        e.formatSize = function (e, n) {
            ...
            return i(this, void 0, void 0, function* () {
                const i = yield Promise.resolve().then(() => t(8));
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(2), o = t(5), s = t(1), a = t(0), l = t(6), d = t(13), c = t(14), u = t(17), f = t(63),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(2), r = t(1), o = t(14), s = t(64), a = t(17), l = t(5), d = r.default.getLogger("ThunderNewTask"),
    ...
    !function (e) {
        ...
        }, e.parseEd2kUrl = C, e.parseUrl = b, e.parseMagnetUrl = function (e) {
    ...
    !function (e) {
        ...
        function t(e) {
            ...
            return null !== r && void 0 !== r && r.length >= 2 && (r = r.toLowerCase()), void 0 === r || "" === r || r.length < 2 ? t = n.Unkown : h.indexOf(r) > -1 ? t = n.Video : p.indexOf(r) > -1 ? t = n.Software : w.indexOf(r) > -1 ? t = n.Doc : m.indexOf(r) > -1 ? t = n.Music : g.indexOf(r) > -1 ? t = n.Pic : v.indexOf(r) > -1 && (t = n.Zip), r.length > 1 && ".z" === r.slice(0, 2) && /[0-9]+/.test(r.substring(2)) && (t = n.Zip), t
        }
        ...
        e.getTaskIcon = function (e, n) {
            ...
            let r = n.Unkown;
            return void 0 === t && void 0 !== e && (t = i.extname(e)), null !== t && void 0 !== t && t.length >= 2 && (t = t.toLowerCase(), t += ";"), void 0 === t || "" === t || t.length < 3 ? r = n.Unkown : s.indexOf(t) > -1 ? r = n.Video : a.indexOf(t) > -1 ? r = n.Software : l.indexOf(t) > -1 ? r = n.Doc : d.indexOf(t) > -1 ? r = n.Music : c.indexOf(t) > -1 ? r = n.Pic : u.indexOf(t) > -1 ? r = n.Zip : f.indexOf(t) > -1 && (r = n.Bt), t.length > 1 && ".z" === t.slice(0, 2) && /[0-9]+/.test(t.substring(2)) && (r = n.Zip), r
    ...
    "use strict";
    var i = t(3), r = t(24), o = t(68), s = t(18);
    ...
    }, l.Cancel = t(35), l.CancelToken = t(91), l.isCancel = t(34), l.all = function (e) {
        return Promise.all(e)
    }, l.spread = t(92), e.exports = l, e.exports.default = l
}, function (e, n) {
    function t(e) {
 ...
 */
    ...
    "use strict";
    var i = t(18), r = t(3), o = t(86), s = t(87);
    ...
    "use strict";
    var i = t(3), r = t(25), o = t(27), s = t(71), a = t(72), l = t(19),
        d = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || t(73);
    e.exports = function (e) {
    ...
    "undefined" == typeof process || "renderer" === process.type ? e.exports = t(78) : e.exports = t(80)
}, function (e, n, t) {
    function i() {
        var e;
        try {
    ...
    "use strict";
    const i = t(8), r = t(83), o = process.env;
    let s;
    ...
    "use strict";
    var i = t(3), r = t(88), o = t(34), s = t(18), a = t(89), l = t(90);
